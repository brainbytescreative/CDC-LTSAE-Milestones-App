...
<html lang="en">
  ...
  <body>
    ...
    {% if isPremature %}
    <p>
      <strong>YOU COMPLETED THIS CHECKLIST FOR YOUR CHILD’S CORRECTED AGE.
      </strong>
    </p>
    {% endif %}
    ...
    <ol style="margin: 0 0; padding-left: 45px;">
      ...
      <li style="padding-left: 5px;">{{concern.value}}
      </li>
      {% endfor %}
    </ol>
    {% endif %}
    ...
    <div style="padding-top: 20px;">
      ...
      child at:
      <a href="https://www.cdc.gov/ncbddd/actearly/concerned.html?s_cid=ncbddd_act_mt_app_em1">cdc.gov/Concerned
      </a>
    </div>
    {% endif %}
    {% if notSureItems.length %}
    <div style="padding-top: 20px;">
      <b>REVISIT these milestones and talk with the doctor if you are still unsure
      </b>
    </div>
    ...
    <ol style="margin: 0 0; padding-left: 45px;">
      ...
      <li style="padding-left: 5px;">{{skipped.value}}
      </li>
      {% endfor %}
    </ol>
    {% endif %}
    ...
    <div style="padding: 25px 0 25px 0;">
      <p>
        <strong>You know {{ childName }} best. If {{heSheTag}} is missing milestones or you ever become
          ...
          concerns, and ask for developmental screening.
        </strong>
      </p>
    </div>
    ...
    <div style="padding-bottom: 40px;">
      ...
      <a href="https://www.cdc.gov/ncbddd/actearly/index.html">
        <a href="https://www.cdc.gov/ncbddd/actearly/index.html?s_cid=ncbddd_act_mt_app_em2">cdc.gov/ActEarly
        </a>
      </a>.
    </div>
    <p>
...
<html lang="es">
  ...
  <body>
    ...
    <div style="padding-top: 5px; padding-left: 25px;">
      ...
      <ins>Indicadores del desarrollo para los 
        <b>{{formattedAge}}
        </b> que marcó 
        <b>“Todavía no”
        </b>
    ...
    <div style="padding-top: 20px;">
      ...
      su hijo en 
      <a href="https://www.cdc.gov/ncbddd/spanish/actearly/concerned.html?s_cid=ncbddd_act_mt_app_sp_em1">www.cdc.gov/Preocupado.
      </a>
    </div>
    {% endif %}
    {% if notSureItems.length %}
    <div style="padding-top: 20px;">
      <b>CONSULTAR NUEVAMENTE estos indicadores
      </b>
    </div>
    <div style="padding-top: 20px; padding-left: 25px;">
      {# 
    ...
    <div style="padding: 25px 0 5px 0;">
      ...
      <p>
        <b>Tómese un tiempo para CELEBRAR que {{ childName }} alcanzó 
          estos indicadores del desarrollo importantes:
        </b>
      </p>
    </div>
    {# 
    ...
    <div style="padding-top: 20px;">
      <p>
        ...
        <b>Regresar a la aplicación Milestone Tracker para CONSULTAR NUEVAMENTE estos indicadores del desarrollo:
        </b>
      </p>
    </div>
    {% if skippedItems.length %}
    ...
    <div style="padding: 25px 0 25px 0;">
      ...
      <p>
        <strong>Usted es quien mejor conoce a {{ childName }}. 
          ...
          hable con el médico, coméntele sus inquietudes y pídale una evaluación del desarrollo. 
        </strong>
      </p> 
    </div>
    {# Thank you again for using CDC’s Milestone Tracker App! #}
    ...
    <div style="padding-bottom: 40px;">
      ...
      <a href="https://www.cdc.gov/ncbddd/actearly/index.html">
        <a href="https://www.cdc.gov/ncbddd/spanish/actearly/index.html?s_cid=ncbddd_act_mt_app_sp_em2">www.cdc.gov/Pronto
        </a>
      </a>.
    </div>
    <p>
      ...
      <i>Este correo electrónico fue generado automáticamente por la aplicación Milestone Tracker de los CDC; no lo responda.
      </i>
    </p>
  </body>
</html>
